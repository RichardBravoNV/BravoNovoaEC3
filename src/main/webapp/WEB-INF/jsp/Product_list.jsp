...
<body>
 <div class="container">
  ...
  <table class="table table-striped">
   ...
   <tbody>
    <c:forEach items="${articleList }" var="product" >
     <tr>
      <td>${article.id }</td>
      <td>${article.title }</td>
      ...
      <td>
       <spring:url value="/product/productArticle/${product.id }" var="deleteURL" />
       <a class="btn btn-primary" href="${deleteURL }" role="button" >Delete</a>
      </td>
      <td>
       <spring:url value="/product/productArticle/${product.id }" var="deleteURL" />
       <a class="btn btn-primary" href="${deleteURL }" role="button" >Delete All</a>
      </td>
     </tr>
    </c:forEach>
   </tbody>
